...
{
  CALL_CRYPTO_SERVICE (TlsSetHostPrivateKeyWithPassword, (Tls, Data, DataSize, Password), EFI_UNSUPPORTED);
}
...
{
  CALL_CRYPTO_SERVICE (TlsExportKey, (Tls, Label, Context, ContextLen, KeyBuffer, KeyBufferLen), EFI_UNSUPPORTED);
}
